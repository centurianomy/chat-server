/******************************* Server side code for creating a server- [using accept() method] ************************************/
import java.net.*;
public class ServerSide{
    public static void main(String args[]){
        try(ServerSocket server= new ServerSocket(1234)){
            ...
            System.out.println(socket.getInetAddress());// to get the IP address of the client. (getInetAddress() is a method of Socket class)
        }
        catch(Exception e){
            e.printStackTrace();
        }
